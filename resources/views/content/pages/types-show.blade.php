      ...
      <div class="card-body">
        <form method="POST" action="{{ route('pages-types-update') }}">
          ...
          <div class="mb-3">
            ...
            <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="bx" data-tick-icon="bx-check" data-style="btn-default" value="{{ $type->icon }}" name="icon">
