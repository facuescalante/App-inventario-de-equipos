...
Route::middleware([
    ...
    Route::get('/sos/show/{sos_id}', $controller_path . '\pages\SistemasOperativos@show')->name('pages-sos-show');
    Route::post('/sos/update', $controller_path . '\pages\SistemasOperativos@update')->name('pages-sos-update');
    Route::get('/sos/destroy/{sos_id}', $controller_path . '\pages\SistemasOperativos@destroy')->name('pages-sos-destroy');
    Route::get('/sos/switch/{sos_id}', $controller_path . '\pages\SistemasOperativos@switch')->name('pages-sos-switch');
    ...
    Route::get('/reports/delete/{id}', $controller_path . '\pages\Reports@delete')->name('pages-reports-delete');
